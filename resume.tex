...
\resumeProjectHeading
    {\textbf{Task Manager – Client-Server System} $|$ \emph{C/C++}}{August 2023 – September 2023}
    \resumeItemListStart
...
\resumeProjectHeading
    {\textbf{Interactive Tabletop System} $|$ \emph{Embedded Systems, Web Development}}{January 2025 – Present}
    \resumeItemListStart
...
\resumeProjectHeading
    {\textbf{Macro Tracking Logger} $|$ \emph{Python}}{December 2024}
    \resumeItemListStart
...
\section{Extracurricular}
    ...
    \resumeSubHeadingListStart
        \resumeSubheading{Additional Activities}{}{}{}\vspace{-13pt}
        \resumeItemListStart
        \resumeItem{Sports and Recreational Activities: Football, Running, Swimming, Skiing, Cycling}
        \resumeItem{Workshops and Certifications: Generative AI, Large Language Models, Responsible AI, Cybersecurity in Healthcare, Microsoft Azure, Cloud Computing, Deep Learning}
        \resumeItem{Pursuing Certification: Microsoft Certified in Security Compliance and Identity Fundamentals}
        \resumeItemListEnd
    \resumeSubHeadingListEnd
